...
```plain
iwr "https://raw.githubusercontent.com/macavall/PwsAzureScriptHardStop/refs/heads/master/PwsAzureScriptHardRestart.ps1" -OutFile PwsAzureScriptHardRestart.ps1 && . ./PwsAzureScriptHardRestart.ps1  
```
