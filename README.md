...
```plain
iwr "[https://raw.githubusercontent.com/macavall/PwsAzureScriptHardStop/refs/heads/master/PwsAzureScriptHardRestart.ps1" -OutFile AzureScriptHardRestart.ps1 && . ./AzureScriptHardRestart.ps1  
```
